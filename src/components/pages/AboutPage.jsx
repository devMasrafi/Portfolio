    ...
    <section className="bg-bg-main-col text-white">
      <div className="container mx-auto ">
        ...
        <div className="ml-20">
          ...
          {/* hobbies */}
          <div>
            <h2 className="font-inter text-3xl capitalize font-bold mt-14 mb-8 ">
              hobbies
            </h2>
            <div>
          ...
          <div className="w-[540px] mt-20 ">
            <h2 className="font-inter capitalize font-bold text-3xl underline underline-offset-[15px]  ">
              looking for
            </h2>
            <p className="py-6 ">
              I'm looking to get into my job into the industry which I have be
              preparing myself for past few years. the past experience of my
              leading of different student educational group and national camps
              helps me a lot on many occasional events.
            </p>
          </div>
        </div>
        {/* contact */}
        <div className="w-[620px] text-center mx-auto py-[120px] ">
          <p className=" mt-20 pb-6">
            Feel free to contact me for anything web related. whether its
            related to designing a web using canva or figma or making a simple
            web app using only basic.
          </p>
